		...
		<div class="row">
			<div class="span9 article article_big">
				...
				<div class="info">
					...
					<p class="teaser"><?php echo $articles[0]->teaser ? $articles[0]->teaser : firstline_or_numwords(strip_tags($articles[0]->content), 10); ?></p>
				</div>
	...
	<div class="row">
		<?php if (isset($articles[1])): ?>
			<div class="span5 article article_medium">
				<a href="<?php echo site_url('nyhed/vis/'.$articles[1]->articles_id); ?>" class="fill" title="<?php echo htmlspecialchars($articles[1]->title); ?>"></a>
				<div class="info">
		...
		<?php if (isset($articles[2])): ?>
			<div class="span4 article article_medium">
				<a href="<?php echo site_url('nyhed/vis/'.$articles[2]->articles_id); ?>" class="fill" title="<?php echo htmlspecialchars($articles[2]->title); ?>"></a>
				<div class="info">
	...
	<div class="row">
		<?php if (isset($articles[3])): ?>
			<div class="span3 article article_small">
				<a href="<?php echo site_url('nyhed/vis/'.$articles[3]->articles_id); ?>" class="fill" title="<?php echo htmlspecialchars($articles[3]->title); ?>"></a>
				<div class="info">
		...
		<?php if (isset($articles[4])): ?>
			<div class="span3 article article_small">
				<a href="<?php echo site_url('nyhed/vis/'.$articles[4]->articles_id); ?>" class="fill" title="<?php echo htmlspecialchars($articles[4]->title); ?>"></a>
				<div class="info">
		...
		<?php if (isset($articles[5])): ?>
			<div class="span3 article article_small">
				<a href="<?php echo site_url('nyhed/vis/'.$articles[5]->articles_id); ?>" class="fill"title="<?php echo htmlspecialchars($articles[5]->title); ?>"></a>
				<div class="info">
